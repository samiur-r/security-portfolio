...
const CustomizedFrameworks = () => {
  return (
    <section className="my-12 px-5 w-full">
      <div
        className="w-full bg-no-repeat bg-[right_top_0px] xl:bg-[right_top_50px] flex flex-col gap-16"
        style={{
          backgroundImage: `url(/3-filled.svg)`,
        }}
      >
        ...
        <div className="container mx-auto flex flex-col gap-16">
          <h3 className="font-glancyr text-xl xl:text-3xl">TITLE GOES HERE</h3>
          <div className="flex flex-col xl:flex-row xl:justify-between gap-16 ">
            <p>
