  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      if (window.innerWidth > 768) {
        ...
        const minWidth = window.innerWidth <= 768 ? 350 : 1100;
        ...
        <div className="h-screen sticky top-0 flex justify-center items-center bg-gradient-to-r from-black to-[#313D46]">
          <div className="absolute top-0 left-0 right-0 bottom-0 flex flex-col justify-center items-start container mx-auto z-30 px-5 md:px-auto">
            {opacity !== 0 && (
              <>
                <h1
                  className="text-4xl mb-4 font-glancyr md:text-7xl tracking-[5px] leading-10"
                  style={{ opacity, transform }}
                >
                  ACHIEVE <b>COMPLIANCE,</b>
                </h1>
                <h1
                  className="text-4xl font-glancyr md:text-7xl tracking-[5px] leading-10"
                  style={{ opacity, transform }}
                >
            ...
            {opacity === 0 && (
              ...
              >
                ...
                <div className="w-full flex justify-center">
                  <h1
                    className="font-glancyr md:text-7xl tracking-[5px] leading-10 text-4xl"
                    style={{
                ...
                <h1
                  className="text-4xl font-glancyr md:text-7xl tracking-[5px] leading-10 w-full flex justify-end"
                  style={{ opacity: secondOpacity, transform: secondTransform }}
                >
                  Earn <b> TRUST.</b>
                </h1>
