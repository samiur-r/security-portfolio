    ...
    <section className="flex flex-col gap-16 w-full">
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between gap-16 ">
        <p>
          ...
          single data breach, whether it affects your internal systems or those
          of a trusted vendor or partner, can result in substantial financial
          losses, potentially reaching a couple million. 
        </p>
        <p>
          With cyber threats constantly evolving, businesses must take proactive
          measures to safeguard their sensitive information. Two widely
          recognized frameworks for achieving this are ISO 27001 and SOC 2,
          which are industry-specific regulations and help organizations meet
