    ...
    <section className="flex flex-col gap-16 w-full">
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between gap-16 ">
        <p>
          ...
          <br /> At SKELDUS, we get that every business is different. That’s why
          our customized frameworks are created to address the specific needs
          and goals of your organization.
        </p>
        <p>
          Whether it's aligning with regional regulations, industry-specific
          requirements, or your distinct business objectives, our solution helps
          you achieve compliance in less time and resources.
        </p>
      </div>
