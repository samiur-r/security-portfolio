...
const ProductSlider: React.FC<ProductSliderProps> = ({ products }) => {
  ...
  return (
    <div className="mt-10 flex flex-col xl:flex-row gap-5 xl:gap-0 xl:h-[596px] flex-1">
      <Image
      ...
      />
      <div className="flex flex-1 justify-center items-center bg-dark-blue relative xl:-ml-20 xl:mt-24 z-0 rounded-lg">
      ...
      {products.length > 1 && (
        <div className="flex items-end justify-center">
          <div className="bg-[#E5E7E8] rounded-lg p-2 flex xl:flex-col gap-2">
